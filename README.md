...
gодготовит файлы к сохранению - запоминает текущее содержимое (контент) файла, !_но НЕ СОХРАНЯЕТ содержимое файлов в репозитории
> git add --all
или
...
*- выполнить коммит (от англ. commit — «совершать», «фиксировать»), сохранение, или фиксацию состояния файлов*
...
ключ -m (от англ. message — «сообщение»), который присваивает коммиту сообщение (пишется после ключа -m в кавычках)
