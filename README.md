# git
	...
	само НЕ делается ничего - только по команде
		точка фиксации - осмысленная сущность, важная для разработчика и она обязательно снабжается названием (комментарием)
